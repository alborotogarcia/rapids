...
RUN pip install --no-cache-dir --user git+https://github.com/cliffwoolley/jupyter_tensorboard.git git+https://github.com/chaoleili/jupyterlab_tensorboard.git wget bentoml git+https://github.com/opensearch-project/opensearch-py pandasticsearch
